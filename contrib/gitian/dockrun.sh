...
RUN	git clone https://codeberg.org/peoplecoin/gitian.sigs.git sigs; \
  ...
  git clone https://codeberg.org/peoplecoin/peoplecoin
...
if [ ! -d sigs ]; then
	git clone https://codeberg.org/peoplecoin/gitian.sigs.git sigs
	cd sigs
